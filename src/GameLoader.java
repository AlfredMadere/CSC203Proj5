...
public final class GameLoader
{
    ...
    //Gonna leave these because they seem to be not really associated ImageStore. They aren't really having to do with storing images. these are more utility methods
    ...
    */
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == SAPLING_NUM_PROPERTIES) {
            ...
            Entity s = Factory.createSapling(id, pt, imageStore.getImageList(SAPLING_KEY));
            world.tryAddEntity(s);
        }
